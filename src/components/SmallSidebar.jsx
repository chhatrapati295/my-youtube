...
const SmallSidebar = () => {
  ...
  return (
    <div
      className={`hidden md:flex flex-col gap-4 py-4 w-16 md:w-20 px-1 text-[0.6rem] font-medium h-full ${
        theme ? "bg-white text-[#0f0f0f]" : "bg-[#0f0f0f] text-white"
      }`}
    >
      <Link to={"/"}>
        <div
          className={`flex flex-col items-center gap-1 cursor-pointer ${
            theme ? "hover:bg-[#f2f2f2]" : "hover:bg-[#393838]"
          }  p-2   rounded-md`}
        >
          <svg
